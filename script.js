...
function handleCalculate() {
    ...
    // Use the mobile-focused scroll function
    if (typeof window.mobileScrollToTop === 'function') {
        // Call immediately
        window.mobileScrollToTop();
        
        // And also with a slight delay to ensure it works in Wix
        setTimeout(function() {
            window.mobileScrollToTop();
        }, 100);
        
        // And one more time with a longer delay for stubborn mobile browsers
        setTimeout(function() {
            window.mobileScrollToTop();
        }, 500);
    } else {
