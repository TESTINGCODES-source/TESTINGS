...
const equationNames = [
  "4 APs",                                                         // Option 1
  "2 APs + 4 Subjects",                                          // Option 6
  "3 APs + 2 Subjects",                                          // Option 7
  "3 APs + ACT1",                                               // Option 9
  "3 APs + School (Grades 10, 11, 12)",                        // Option 11
  "2 APs + 2 Subjects + School (Grades 10, 11, 12)",           // Option 12
  "1 AP + 4 Subjects + School (Grades 10, 11, 12)",            // Option 13
  "2 APs + ACT1 + School (Grades 10, 11, 12)",                 // Option 14
  "1 AP + 2 Subjects + ACT1 + School (Grades 10, 11, 12)",     // Option 15
  "1 AP + 6 Subjects",                                          // Option 4
  "1 AP + 4 Subjects + ACT1",                                   // Option 5
  "2 APs + 2 Subjects + ACT1",                                  // Option 8
  "8 Subjects",                                                 // Option 2
  "6 Subjects + ACT1",                                          // Option 3
  "6 Subjects + School (Grades 10, 11, 12)",                   // Option 10
  "ACT1 + 4 Subjects + School (Grades 10, 11, 12)"             // Option 16
];
...
const Equations = [
    ...
    // Equation 6: 1 AP + 4 Subjects + School (Grades 10, 11, 12)
    ...
    // Equation 14: 6 Subjects + School (Grades 10, 11, 12)
    ...
    // Equation 15: ACT1 + 4 Subjects + School (Grades 10, 11, 12)
