...
function handleCalculate() {
    ...
    // Basic scrolling for all environments
    window.scrollTo({ top: 0, behavior: 'smooth' });
    document.body.scrollTop = 0;
    document.documentElement.scrollTop = 0;
    
    // Call our specialized Wix mobile scrolling function
    scrollWixMobile();
    ...
    setTimeout(() => {
        // Basic scrolling again after a delay
        window.scrollTo({ top: 0, behavior: 'smooth' });
        document.body.scrollTop = 0;
        document.documentElement.scrollTop = 0;
        
        // Call specialized function again after delay
        scrollWixMobile();
